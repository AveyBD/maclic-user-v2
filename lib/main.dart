...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyBPy47sCfuEidNbnwOEpBlgzUM8FgJjssI",
        authDomain: "maclic-96a2f.firebaseapp.com",
        databaseURL: "https://maclic-96a2f-default-rtdb.europe-west1.firebasedatabase.app",
        projectId: "maclic-96a2f",
        storageBucket: "maclic-96a2f.appspot.com",
        messagingSenderId: "891269160316",
        appId: "1:891269160316:web:633397532e6f9f170a58f9",
        measurementId: "G-ECSRRVYT5H"
    ));
    MetaSEO().config();
  }else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyAkh9gfLnEWWIP6AIIX4LUlJybdpE8mxZE",
        appId: "1:891269160316:android:4ba7b2bc71bdc3880a58f9",
        messagingSenderId: "891269160316",
        projectId: "maclic-96a2f",
      ),
    );
